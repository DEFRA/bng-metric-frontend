 ...
 * habitat (BMD-724). All values are display strings; the template renders them
 * as a govukSummaryList with no form controls. Relative to the baseline
 * watercourse details page this adds an "Intervention" row and drops the
 * trading-rules row.
 *
 * Post-intervention values are read from `proposed`, mirroring the area page
 * (BMD-608) and the editable watercourse page; for a retained watercourse the
