...
// is what lets pages like `upload-geopackage-file.njk` be addressed by
// the name Nunjucks uses for includes. Hapi Vision still resolves
// `h.view()` paths from `src/server/` (e.g. `common/templates/...`).
